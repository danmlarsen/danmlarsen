...
### Key skills & tools
[![My Skills](https://skillicons.dev/icons?i=html,css,js,ts,tailwind,react,nextjs,gatsby,scss,linux,nodejs,docker,cs,dotnet,nest,express,vue,angular,postgresql,prisma,mongodb,supabase,aws,azure,jest,vitest,figma&perline=6)](https://github.com/danmlarsen/)
